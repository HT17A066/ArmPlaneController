...
#ifndef ARMPLANECONTROLLER_H
#define ARMPLANECONTROLLER_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ArmPlaneController(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void ArmPlaneControllerInit(RTC::Manager* manager);
};

#endif // ARMPLANECONTROLLER_H
